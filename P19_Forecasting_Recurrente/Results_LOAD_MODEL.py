...
from P15_Forecasting_RedConcurrente.RedNeuronalRecurrente_Simple import CustomNormalization, calc_rmse, \
    train_val_test_split, create_supervised_dataset
...
if __name__ == '__main__':
    ...
    model = load_model('Mejor_Modelo/modelo_mejora_1.keras', custom_objects={
